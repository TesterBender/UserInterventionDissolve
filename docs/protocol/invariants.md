...
| INV-9 | Aggregate tags may not bypass individually tagged character ownership. | §7 | `grammar`, `lint` |
...
## INV-9 {#inv-9}
`Everyone:` and similar universal tags are forbidden; aggregates commit only currently unindividuated members (§7).
