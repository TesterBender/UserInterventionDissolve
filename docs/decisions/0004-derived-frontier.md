...
- Automatic freezing is off until brief 0020b supplies the offset → `(messageId, offset)` mapping (`docs/modules/recovery.md#freeze-hookup`). Nothing is frozen in the meantime, and `selectCut` is unchanged.
