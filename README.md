...
```
npm install
npm run check          # lint + tests + comment pointers + doc links
npm run build:preset   # regenerate presets/ from src/prompt.js
```

Documentation index: `docs/README.md`. Working agreements: `CLAUDE.md`.
